...
wsize      = 10;            % size of smoothing window (in time points; 0 -> no smoothing)
...
% input
ts = load(['timeseries' '/' 'ts' '_dosplit_' num2str(do_split) ...
    '_splitby_' split_by '_splittrun_' num2str(split_trun) '_online_'  num2str(online(o)) '.mat']);
...
if ~strcmp(trunc, 'no')
    ...
    varana = load([datadir '/' 'stats_' 'varanalysis' '_story_' num2str(story(st)) ... % varana output
            ...
            '_splittrun_' num2str(split_trun) '_online_' num2str(online(o)) '.mat']);
...
savefile = [outdir '/' 'sets' '_story_' num2str(story(st)) ...
    '_nsets_' num2str(n_sets) '_smoothtype_' smoothtype ...
    '_wsize_' num2str(wsize(w)) '_dosplit_' num2str(do_split) ... 
    '_splitby_' split_by '_split_' num2str(split) '_splittrun_' ...
    num2str(split_trun) '_trunc_' trunc '_online_' num2str(online(o)) '.mat'];
