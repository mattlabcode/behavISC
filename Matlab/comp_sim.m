...
% define params
n_perm     = 500;       % it of ts perm (default = 500); if 'nt', use # tps
...
splits = load([datadir '/' 'splits' '_story_' num2str(story(st)) '_nsets_' num2str(n_sets) ...
    '_smoothtype_' smoothtype '_wsize_' num2str(wsize(w)) '_dosplit_' num2str(do_split) ...
    '_splitby_' split_by '_split_' num2str(split_num) '_splittrun_' num2str(split_trun) ...
...
savefile = [outdir '/' 'corr' '_story_' num2str(story(st)) '_nsets_' num2str(n_sets) ...
    '_smoothtype_' smoothtype '_wsize_' num2str(wsize(w)) '_dosplit_' num2str(do_split) ...
    '_splitby_' split_by '_split_' num2str(split_num) '_splittrun_' num2str(split_trun) ...
    '_trunc_' trunc '_nperm_' num2str(n_perm) '_online_' num2str(online(o)) '.mat'];
