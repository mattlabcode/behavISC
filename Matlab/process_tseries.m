...
% define file params
online     = 0;                   % read in files for online (1) or in-lab study (0)
...
% savefile
savefile = ['timeseries' '/' 'ts' '_dosplit_' num2str(do_split) ...
    '_splitby_' split_by '_splittrun_' num2str(split_trun) '_online_' num2str(online) '.mat'];
