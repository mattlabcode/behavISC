...
if strcmp(plot_type, 'corrcause')
    ...
    input_sig = load(['correlations/corr_story_' num2str(story) '_nsets_' num2str(n_sets) ...
        '_smoothtype_' smoothtype '_wsize_' num2str(wsize) '_dosplit_' num2str(do_split) ...
        '_splitby_' split_by '_split_' num2str(split) '_splittrun_' num2str(split_trun) ...
        '_trunc_sig' '_nperm_' num2str(n_perm) '_online_' num2str(online) '.mat']);
    input_nsig = load(['correlations/corr_story_' num2str(story) '_nsets_' num2str(n_sets) ...
        '_smoothtype_' smoothtype '_wsize_' num2str(wsize) '_dosplit_' num2str(do_split) ...
        '_splitby_' split_by '_split_' num2str(split) '_splittrun_' num2str(split_trun) ...
        '_trunc_nsig' '_nperm_' num2str(n_perm) '_online_' num2str(online) '.mat']);
else
    input = load(['correlations/corr_story_' num2str(story) '_nsets_' num2str(n_sets) ...
        '_smoothtype_' smoothtype '_wsize_' num2str(wsize) '_dosplit_' num2str(do_split) ...
        '_splitby_' split_by '_split_' num2str(split) '_splittrun_' num2str(split_trun) ...
...
% savefile
outdir = 'figures_sim';
savefile = [outdir '/' plot_type '_story_' num2str(story) '_nsets_' num2str(n_sets) ...
    '_smoothtype_' smoothtype '_wsize_' num2str(wsize) '_dosplit_' num2str(do_split) ...
    '_splitby_' split_by '_split_' num2str(split) '_splittrun_' num2str(split_trun) ...
...
if do_save
    if exist(savefile, 'file')
        choice = questdlg('Warning: Savefile already exists. Overwrite?', ...
            'Warning', 'no', 'yes', 'proceed without saving', 'no');
        switch choice
            case 'no'
