...
function H=makeSignificanceBar(x,y,p)
    ...
    %instead of a star. 
    if ~isnan(p)
        offset=0.009; %****EDIT: default offset = .0005; .008
    else
        offset=0.04; %****EDIT: default offset = .02; .03
    end
    ...
    H(2)=text(mean(x(:)),starY,stars,...
        ...
        'Tag','sigstar_stars', 'fontsize', 12, 'fontname', 'arial'); %***EDIT: fontsize/fontname originally not specified
