...
sets = load([datadir '/' 'sets' '_story_' num2str(story(st)) '_scrambled_' num2str(sc) '_nsets_' num2str(n_sets) '_smoothtype_' smoothtype '_wsize_' num2str(wsize(w)) '_dosplit_' num2str(do_split) '_splitby_' split_by '_split_' num2str(split) '_splittrun_' num2str(split_trun) '_trunc_' trunc '_online_' num2str(online(o)) '.mat']);
sets = sets.sets;
...
savefile = [outdir '/' 'splits' '_story_' num2str(story(st)) '_scrambled_' num2str(sc) '_nsets_' num2str(n_sets) '_smoothtype_' smoothtype '_wsize_' num2str(wsize(w)) '_dosplit_' num2str(do_split) '_splitby_' split_by '_split_' num2str(split) '_splittrun_' num2str(split_trun) '_trunc_' trunc '_online_' num2str(online(o)) '.mat'];
